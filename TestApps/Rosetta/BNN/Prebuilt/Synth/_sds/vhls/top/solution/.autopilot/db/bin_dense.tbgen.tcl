...
set portList { 
	...
	{ layer_type_V sc_in sc_lv 2 signal 7 } 
	{ d_i_idx_V sc_in sc_lv 1 signal 8 } 
	{ d_o_idx_V sc_in sc_lv 1 signal 9 } 
	{ o_index_V sc_in sc_lv 16 signal 10 } 
	{ n_inputs sc_in sc_lv 16 signal 11 } 
	{ n_outputs sc_in sc_lv 16 signal 12 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "16", "Max" : "79"}
	, {"Name" : "Interval", "Min" : "16", "Max" : "79"}
]}
