...
HD_PWD='/var/tmp/tmp.ad3h9wxxaq/_sds/p0/ipi/pynq.runs/pynq_m04_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_m04_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pynq_m04_regslice_0.tcl
