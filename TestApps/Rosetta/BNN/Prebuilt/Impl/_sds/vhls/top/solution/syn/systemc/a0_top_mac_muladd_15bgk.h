...
#ifndef __a0_top_mac_muladd_15bgk__HH__
#define __a0_top_mac_muladd_15bgk__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(a0_top_mac_muladd_15bgk) {
    ...
    SC_CTOR(a0_top_mac_muladd_15bgk):  simcore_mac_0_U ("simcore_mac_0_U") {
