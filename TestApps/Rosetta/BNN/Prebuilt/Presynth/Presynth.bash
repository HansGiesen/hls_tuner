...
/mnt/icgridio2/safe/giesen/HLS_tuner/1/Scripts/Timeout.bash -t 900 \
  /usr/bin/time -f "Runtime: %e s\nMaximum residential set size: %M KB" -o /dev/stdout \
    make -f /mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/Rosetta/BNN/Sources/Makefile clean all \
      JOBS=4 \
      THREADS=4 \
      HLS_TUNER_DEFINES='' \
      DATA_MOVER_CLOCK=2 \
