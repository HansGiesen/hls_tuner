...
HD_PWD='/scratch/local/tmp.MCX0lb37KH/_sds/p0/ipi/pynq.runs/pynq_axcache_0xE_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_axcache_0xE_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pynq_axcache_0xE_0.tcl
