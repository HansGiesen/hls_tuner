...
HD_PWD='/scratch/local/tmp.HG4IAH4zV1/_sds/p0/ipi/pynq.runs/pynq_s00_data_fifo_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_s00_data_fifo_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pynq_s00_data_fifo_1.tcl
