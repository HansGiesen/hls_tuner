...
entity a0_aes_expandEncKey_bkb_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of a0_aes_expandEncKey_bkb_rom is 
...
entity a0_aes_expandEncKey_bkb is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of a0_aes_expandEncKey_bkb is
    component a0_aes_expandEncKey_bkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    a0_aes_expandEncKey_bkb_rom_U :  component a0_aes_expandEncKey_bkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
