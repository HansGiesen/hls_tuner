...
${HLS_TUNER_ROOT}/Scripts/Timeout.sh -t 900 \
  make -f /mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/MachSuite/aes/Sources/Makefile clean all \
  JOBS=4 \
  THREADS=1 \
  HLS_TUNER_DEFINES=' -DPIPELINE_CPKEY -DUNROLL_FACTOR_EXP1=1 -DUNROLL_FACTOR_EXP2=1 -DUNROLL_FACTOR_ECB1=15 -DUNROLL_FACTOR_ECB3=10 -DUNROLL_FACTOR_ECB2=8 -DPIPELINE_II_ADDKEY=7 -DPIPELINE_II_ECB1=12 -DPIPELINE_II_ECB2=7 -DPIPELINE_II_ECB3=12 -DPIPELINE_II_EXP1=1 -DPIPELINE_II_EXP2=1 -DPIPELINE_EXP2 -DPIPELINE_EXP1 -DUNROLL_FACTOR_ADDKEY=11 -DUNROLL_FACTOR_SUB=1 -DUNROLL_FACTOR_MIX=3 -DPIPELINE_II_CPKEY=1 -DPIPELINE_II_MIX=3 -DPIPELINE_ECB2 -DUNROLL_FACTOR_CPKEY=6 -DPIPELINE_II_SUB=9' \
  DATA_MOVER_CLOCK=1 \
