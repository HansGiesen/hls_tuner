; ModuleID = '/scratch/local/tmp.wBr2TBiwTt/_sds/vhls/encrypt/solution/.autopilot/db/a.g.1.bc'
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 31, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !133 ; [debug line = 307:1]
...
; <label>:3                                       ; preds = %.preheader
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 5, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !139 ; [debug line = 315:1]
...
; <label>:6                                       ; preds = %5
  ...
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 12, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !147 ; [debug line = 329:1]
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 9, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !168 ; [debug line = 185:1]
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !201 ; [debug line = 248:1]
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 2, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !263 ; [debug line = 217:1]
...
; <label>:2                                       ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 4, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)), !dbg !276 ; [debug line = 201:1]
...
!139 = metadata !{i32 315, i32 1, metadata !128, null}
...
!147 = metadata !{i32 329, i32 1, metadata !145, null}
...
!263 = metadata !{i32 217, i32 1, metadata !262, null}
