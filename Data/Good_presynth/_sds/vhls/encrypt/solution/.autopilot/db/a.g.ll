; ModuleID = '/scratch/local/tmp.wBr2TBiwTt/_sds/vhls/encrypt/solution/.autopilot/db/a.g.bc'
...
; <label>:7                                       ; preds = %3
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 9, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !121 ; [debug line = 185:1]
...
; <label>:8                                       ; preds = %4
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 4, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !136 ; [debug line = 201:1]
...
; <label>:9                                       ; preds = %5
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 2, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !153 ; [debug line = 217:1]
...
; <label>:7                                       ; preds = %3
  ...
  call void bitcast (void (...)* @_ssdm_Unroll to void (i32, i32, i32, i8*)*)(i32 1, i32 0, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !201 ; [debug line = 248:1]
...
; <label>:16                                      ; preds = %12
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 31, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !271 ; [debug line = 307:1]
...
; <label>:41                                      ; preds = %37
  ...
  call void bitcast (void (...)* @_ssdm_op_SpecPipeline to void (i32, i32, i32, i32, i8*)*)(i32 5, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !280 ; [debug line = 315:1]
...
; <label>:58                                      ; preds = %54
  ...
  call void bitcast (void (...)* @_ssdm_Unroll to void (i32, i32, i32, i8*)*)(i32 1, i32 0, i32 12, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !288 ; [debug line = 329:1]
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"/scratch/local/tmp.wBr2TBiwTt/_sds/vhls/encrypt/solution/.autopilot/db/aes.pragma.2.c", metadata !"/scratch/local/tmp.wBr2TBiwTt/_sds/vhls", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !41} ; [ DW_TAG_compile_unit ]
...
!6 = metadata !{i32 786473, metadata !"/mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/MachSuite/aes/Sources/aes.c", metadata !"/scratch/local/tmp.wBr2TBiwTt/_sds/vhls", null} ; [ DW_TAG_file_type ]
...
!32 = metadata !{i32 786473, metadata !"/mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/MachSuite/aes/Sources/aes.h", metadata !"/scratch/local/tmp.wBr2TBiwTt/_sds/vhls", null} ; [ DW_TAG_file_type ]
...
!69 = metadata !{i32 786473, metadata !"/mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/MachSuite/common/support.h", metadata !"/scratch/local/tmp.wBr2TBiwTt/_sds/vhls", null} ; [ DW_TAG_file_type ]
...
!72 = metadata !{i32 786473, metadata !"/usr/include/libio.h", metadata !"/scratch/local/tmp.wBr2TBiwTt/_sds/vhls", null} ; [ DW_TAG_file_type ]
...
!77 = metadata !{i32 786473, metadata !"/usr/include/bits/sys_errlist.h", metadata !"/scratch/local/tmp.wBr2TBiwTt/_sds/vhls", null} ; [ DW_TAG_file_type ]
...
!153 = metadata !{i32 217, i32 1, metadata !152, null}
...
!201 = metadata !{i32 248, i32 1, metadata !200, null}
...
!280 = metadata !{i32 315, i32 1, metadata !279, null}
...
!288 = metadata !{i32 329, i32 1, metadata !287, null}
