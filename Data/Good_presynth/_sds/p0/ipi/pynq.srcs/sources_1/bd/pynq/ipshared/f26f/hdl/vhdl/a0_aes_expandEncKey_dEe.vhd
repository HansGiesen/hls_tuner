...
entity a0_aes_expandEncKey_dEe_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of a0_aes_expandEncKey_dEe_rom is 
...
entity a0_aes_expandEncKey_dEe is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of a0_aes_expandEncKey_dEe is
    component a0_aes_expandEncKey_dEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    a0_aes_expandEncKey_dEe_rom_U :  component a0_aes_expandEncKey_dEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
