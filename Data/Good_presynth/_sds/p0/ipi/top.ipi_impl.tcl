...
puts "Running ipi tcl"
open_project /scratch/local/tmp.wBr2TBiwTt/_sds/p0/ipi/pynq.xpr
set_param cg.skipHiddenCheck true
set_property ip_repo_paths {/scratch/local/tmp.wBr2TBiwTt/_sds/iprepo/repo /mnt/icgridio2/safe/SDSoC/SDx/2017.1/data/ip/xilinx /mnt/icgridio2/safe/SDSoC/SDx/2017.1/data/cache/xilinx} [current_fileset]
...
open_run impl_1
file mkdir /scratch/local/tmp.wBr2TBiwTt/_sds/p0/ipi/pynq.sdk
write_hwdef -force -file /scratch/local/tmp.wBr2TBiwTt/_sds/p0/ipi/pynq.sdk/pynq.hdf
