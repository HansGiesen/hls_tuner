...
HD_PWD='/scratch/local/tmp.tEdaivbEa4/_sds/p0/ipi/pynq.runs/pynq_auto_us_df_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_auto_us_df_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pynq_auto_us_df_2.tcl
