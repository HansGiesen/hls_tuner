...
HD_PWD='/scratch/local/tmp.tEdaivbEa4/_sds/p0/ipi/pynq.runs/pynq_dm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_dm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pynq_dm_0_0.tcl
