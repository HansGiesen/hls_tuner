...
struct a0_aes_shiftRows : public sc_module {
    ...
    sc_signal< sc_lv<32> > buf_addr_14_reg_481;
    sc_signal< sc_logic > ap_sig_ioackin_m_axi_buf_r_ARREADY;
    sc_signal< sc_lv<8> > i_reg_488;
    sc_signal< sc_lv<8> > buf_addr_14_read_reg_493;
    sc_signal< sc_logic > ap_sig_ioackin_m_axi_buf_r_AWREADY;
    sc_signal< sc_lv<32> > buf_addr_15_reg_498;
    sc_signal< sc_lv<8> > buf_addr_15_read_reg_505;
    sc_signal< sc_lv<32> > buf_addr_16_reg_510;
    sc_signal< sc_lv<8> > buf_addr_16_read_reg_517;
    sc_signal< sc_lv<32> > buf_addr_17_reg_522;
    sc_signal< sc_lv<32> > buf_addr_18_reg_529;
    sc_signal< sc_lv<8> > i_1_reg_536;
    sc_signal< sc_lv<8> > buf_addr_18_read_reg_541;
    sc_signal< sc_lv<32> > buf_addr_19_reg_546;
    sc_signal< sc_lv<32> > buf_addr_20_reg_553;
    sc_signal< sc_lv<8> > j_reg_560;
    sc_signal< sc_lv<8> > buf_addr_20_read_reg_565;
    sc_signal< sc_lv<32> > buf_addr_21_reg_570;
    sc_signal< sc_lv<32> > buf_addr_22_reg_577;
    sc_signal< sc_lv<32> > buf_addr_23_reg_584;
    sc_signal< sc_lv<32> > buf_addr_24_reg_591;
    sc_signal< sc_lv<8> > buf_addr_21_read_reg_598;
    sc_signal< sc_lv<8> > buf_addr_22_read_reg_603;
    sc_signal< sc_lv<8> > j_1_reg_608;
    sc_signal< sc_lv<8> > buf_addr_24_read_reg_613;
