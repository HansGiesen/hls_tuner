...
shopt -s dotglob
cp -r /mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/MachSuite/aes/Output/0001/Synth/* .
...
${HLS_TUNER_ROOT}/Scripts/Timeout.sh -t 1800 \
  vivado -nolog -nojournal -mode batch -source /mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/MachSuite/aes/Output/0001/Impl/Impl.tcl && EXIT_CODE=0 || EXIT_CODE=$?
