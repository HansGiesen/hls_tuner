...
shopt -s dotglob
cp -r /mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/MachSuite/aes/Output/0008/Synth/* .
...
${HLS_TUNER_ROOT}/Scripts/Timeout.bash -t 1800 \
  /usr/bin/time -f "Runtime: %e s\nMaximum residential set size: %M KB" -o /dev/stdout \
    vivado -nolog -nojournal -mode batch -source /mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/MachSuite/aes/Output/0008/Impl/Impl.tcl && EXIT_CODE=0 || EXIT_CODE=$?
