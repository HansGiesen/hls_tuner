...
set Interfaces {
    ap_clk {
        ...
        buses "m_axi_ctx_key m_axi_ctx_enckey m_axi_ctx_deckey m_axi_buf_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_ctx_key {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ctx_key"
        data_width "32"
        param_prefix "C_M_AXI_CTX_KEY"
    ...
    m_axi_ctx_enckey {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ctx_enckey"
        data_width "32"
        param_prefix "C_M_AXI_CTX_ENCKEY"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_ctx_deckey {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ctx_deckey"
        data_width "32"
        param_prefix "C_M_AXI_CTX_DECKEY"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 14169 II x}
...
set enable_xo_gen 0
set kernel_files {/mnt/icgridio2/safe/giesen/HLS_tuner/1/TestApps/MachSuite/aes/Sources/aes.c}
if {$enable_xo_gen} {
