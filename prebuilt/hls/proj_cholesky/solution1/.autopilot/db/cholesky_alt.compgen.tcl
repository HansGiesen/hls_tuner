...
set id 1
set name cholesky_top_fadd_32ns_32ns_32_4_no_dsp_1
...
set id 2
set name cholesky_top_faddfsub_32ns_32ns_32_4_full_dsp_1
...
set id 3
set name cholesky_top_fmul_32ns_32ns_32_3_max_dsp_1
...
set id 4
set name cholesky_top_fcmp_32ns_32ns_1_2_1
...
set id 5
set name cholesky_top_fsqrt_32ns_32ns_32_8_1
...
set id 6
set name cholesky_top_frsqrt_32ns_32ns_32_8_full_dsp_1
...
set id 7
set name cholesky_top_mac_mul_sub_8s_8s_8s_14_1_1
...
set out_width 14
set exp i0*i1+i2
set arg_lists {i0 {8 1 +} i1 {8 1 +} m {14 1 +} i2 {8 1 -} p {14 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 8
set name cholesky_top_mac_mul_sub_7s_7s_7s_13_1_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 13
set exp i0*i1+i2
set arg_lists {i0 {7 1 +} i1 {7 1 +} m {13 1 +} i2 {7 1 -} p {13 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set ID 17
set hasByteEnable 0
set MemName cholesky_alt_L_internal
...
set ID 18
set hasByteEnable 0
set MemName cholesky_alt_diag_internal
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 66
