...
if {[file isfile cholesky_top.autotvin.dat]} {
	file delete -force cholesky_top.autotvin.dat
}

if {[file isfile cholesky_top.autotvout.dat]} {
	file delete -force cholesky_top.autotvout.dat
}
