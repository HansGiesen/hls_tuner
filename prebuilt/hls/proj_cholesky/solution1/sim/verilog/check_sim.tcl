...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.cholesky_top.autotvin_A.dat"
         "c.cholesky_top.autotvin_L.dat"
         "c.cholesky_top.autotvout_L.dat"
         "c.cholesky_top.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.cholesky_top.autotvout_L.dat"
         "rtl.cholesky_top.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
