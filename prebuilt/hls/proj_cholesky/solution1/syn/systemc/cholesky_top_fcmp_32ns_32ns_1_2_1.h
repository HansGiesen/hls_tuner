...
// ==============================================================
#ifndef __cholesky_top_fcmp_32ns_32ns_1_2_1__HH__
#define __cholesky_top_fcmp_32ns_32ns_1_2_1__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cholesky_top_fcmp_32ns_32ns_1_2_1) {
    ...
    SC_CTOR(cholesky_top_fcmp_32ns_32ns_1_2_1):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
